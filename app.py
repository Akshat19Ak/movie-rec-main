...
qp_view = params.get("view")
if isinstance(qp_view, list): qp_view = qp_view[0]
qp_id = params.get("id")
if isinstance(qp_id, list): qp_id = qp_id[0]
...
def goto_details(tmdb_id: int):
    ...
    if hasattr(st, "query_params"):
        ...
        st.experimental_set_query_params(view="details", id=str(int(tmdb_id)))
    st.rerun()
